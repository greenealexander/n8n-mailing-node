...
const AccountCreated = ({ name }: { name: string }) => (
	<Mjml>
		<Head />
		<MjmlBody width={600}>
			<Header loose />
			...
			<MjmlSection padding="0 24px" cssClass="smooth">
				<MjmlColumn>
					...
					<MjmlText
						...
						cssClass="paragraph"
					>
						Thank you for joining BookBook! We’re excited to help you enjoy great meals without any
						begging, guessing, waiting or phone calls. Just a couple taps, and the table is yours.
					</MjmlText>
